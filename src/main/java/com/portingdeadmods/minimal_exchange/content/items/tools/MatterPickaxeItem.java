...
public class MatterPickaxeItem extends PickaxeItem implements MatterItem, MatterToolItem {
    public static final ItemAttributeModifiers ATTRIBUTE_MODIFIERS = PickaxeItem.createAttributes(METoolTiers.MATTER, 1, -2.8f);

    public MatterPickaxeItem(Tier tier, Properties properties) {
        super(tier, properties);
    }

    @Override
    public int getMatterCapacity(ItemStack itemStack) {
        return MEConfig.matterPickaxeCapacity;
    }
    ...
    public int getMatterUsage(ItemStack itemStack, @Nullable Entity entity) {
        return MEConfig.matterPickaxeUsage;
    }
