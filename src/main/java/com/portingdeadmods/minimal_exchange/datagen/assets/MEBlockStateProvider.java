...
public class MEBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(MEBlocks.CRUCIBLE_EXTENSION.get(), models().getExistingFile(MinimalExchange.rl("block/crucible_extension")));

        BlockModelBuilder crucibleModel = models().withExistingParent(key(MEBlocks.CRUCIBLE.get()).toString(), MinimalExchange.rl("block/crucible_base"))
        ...
        BlockModelBuilder crucibleConnectedModel = models().withExistingParent(key(MEBlocks.CRUCIBLE.get()).withSuffix("_connected").toString(), MinimalExchange.rl("block/crucible_base"))
                ...
                .texture("4", "minimal_exchange:block/crucible_inside")
                .texture("5", "minimal_exchange:block/crucible_top_inside");
        getVariantBuilder(MEBlocks.CRUCIBLE.get()).partialState().with(CrucibleBlock.CONNECTED_TOP, false)
