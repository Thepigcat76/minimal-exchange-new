...
public class MatterShovelItem extends ShovelItem implements MatterItem, MatterToolItem {
    public static final ItemAttributeModifiers ATTRIBUTE_MODIFIERS = PickaxeItem.createAttributes(METoolTiers.MATTER, 1.5f, -3);

    public MatterShovelItem(Tier tier, Properties properties) {
        super(tier, properties);
    }

    @Override
    public int getMatterCapacity(ItemStack itemStack) {
        return MEConfig.matterShovelCapacity;
    }
    ...
    public int getMatterUsage(ItemStack itemStack, @Nullable Entity entity) {
        return MEConfig.matterShovelUsage;
    }
