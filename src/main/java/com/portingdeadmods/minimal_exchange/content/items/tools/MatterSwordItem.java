...
public class MatterSwordItem extends SwordItem implements MatterItem, MatterToolItem {
    public static final ItemAttributeModifiers ATTRIBUTE_MODIFIERS = PickaxeItem.createAttributes(METoolTiers.MATTER, 3, -2.4f);

    public MatterSwordItem(Tier tier, Properties properties) {
    ...
    public int getMatterUsage(ItemStack itemStack, @Nullable Entity entity) {
        return MEConfig.matterSwordUsage;
    }
