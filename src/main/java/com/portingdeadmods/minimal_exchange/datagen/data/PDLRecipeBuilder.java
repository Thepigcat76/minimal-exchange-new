...
public class PDLRecipeBuilder<T extends Recipe<?>> implements RecipeBuilder {
    private final T recipe;

    private PDLRecipeBuilder(T recipe) {
        this.recipe = recipe;
    }

    public static <T extends Recipe<?>> PDLRecipeBuilder<T> of(T recipe) {
        return new PDLRecipeBuilder<>(recipe);
    }
    ...
    public void save(RecipeOutput recipeOutput) {
        ...
        save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MinimalExchange.MODID, recipe.getType() + "/" + builder));
    }
