...
public class MatterHoeItem extends HoeItem implements MatterItem, MatterToolItem {
    public static final ItemAttributeModifiers ATTRIBUTE_MODIFIERS = PickaxeItem.createAttributes(METoolTiers.MATTER, -3, 0);
    ...
    public int getMatterCapacity(ItemStack itemStack) {
        return MEConfig.matterHoeCapacity;
    }
    ...
    public int getMatterUsage(ItemStack itemStack, @Nullable Entity entity) {
        return MEConfig.matterHoeUsage;
    }
