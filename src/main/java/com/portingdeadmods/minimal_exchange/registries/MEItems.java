...
public final class MEItems {
    ...
    public static final Supplier<Item.Properties> TOOL_PROPERTIES = () -> new Item.Properties()
    ...
    public static final DeferredItem<MatterPickaxeItem> MATTER_PICKAXE = ITEMS.register("matter_pickaxe", () -> new MatterPickaxeItem(METoolTiers.MATTER, TOOL_PROPERTIES.get()));
    public static final DeferredItem<MatterAxeItem> MATTER_AXE = ITEMS.register("matter_axe", () -> new MatterAxeItem(METoolTiers.MATTER, TOOL_PROPERTIES.get()));
    public static final DeferredItem<MatterShovelItem> MATTER_SHOVEL = ITEMS.register("matter_shovel", () -> new MatterShovelItem(METoolTiers.MATTER, TOOL_PROPERTIES.get()));
    public static final DeferredItem<MatterHoeItem> MATTER_HOE = ITEMS.register("matter_hoe", () -> new MatterHoeItem(METoolTiers.MATTER, TOOL_PROPERTIES.get()));
